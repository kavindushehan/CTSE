...
class NoetScreen extends StatefulWidget {
  String noteId;
  String categoryId;

  NoetScreen(this.noteId, this.categoryId);

  @override
  _NoetScreenState createState() => _NoetScreenState();
}

class _NoetScreenState extends State<NoetScreen> {
  ...
  Future insert(
      String name, String noteDescription, String id, String categoryId) async {
                  ...
                  MaterialButton(
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        _enterTransaction(widget.noteId, widget.categoryId);
                        Navigator.of(context).pop();
                      }
                    },
                  )
  ...
  void _newEditAndDeleteTransaction(
      DocumentReference<Object?> reference, Map? data) {
    showDialog(
        barrierDismissible: false,
        context: context,
        builder: (BuildContext context) {
          ...
          if (snapshot.hasData) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return InkWell(
                  onTap: () {
                    _newEditAndDeleteTransaction(
                        snapshot.data!.docs[index].reference, data);
                  },
                  child: Card(
                    color: bg,
                    child: Padding(
  ...
  void save(DocumentReference<Object?> reference, Map? data) async {
    if (_formKey.currentState!.validate()) {
      ...
      String name = "";
      if (_isIncome == true) {
        amount = double.parse(_textcontrollerAMOUNT.text) +
